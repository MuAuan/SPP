...
# モデルのサマリを表示
model.summary()
model.load_weights('./cifar10/weights_cifar10.hdf5')
...
model.save_weights('./cifar10/weights_cifar10_initial.hdf5', True) 
...
for i in range(epochs):
    ...
    if not data_augmentation:
        ...
        # 学習履歴をプロット
        checkpointer = ModelCheckpoint(filepath='./cifar10/weights_only_cifar10.hdf5', 
